...
namespace Dwarf.Toolkit.Basic.LinqBinder.Tests;
...
public class BindingUnitTest
{
	...
	class DataA
	{
		...
		protected virtual void OnPropAChanged() => PropAChanged?.Invoke(this, EventArgs.Empty);
	}
	...
	class DataB
	{
		...
		protected virtual void OnPropCChanged() => PropCChanged?.Invoke(this, EventArgs.Empty);
	}
