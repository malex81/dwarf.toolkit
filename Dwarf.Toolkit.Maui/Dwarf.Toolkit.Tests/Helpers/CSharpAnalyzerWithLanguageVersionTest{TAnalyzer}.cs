...
namespace Dwarf.Toolkit.Tests.Helpers;
	...
	where TAnalyzer : DiagnosticAnalyzer, new()
{
	...
	public static Task VerifyAnalyzerAsync(string source, LanguageVersion languageVersion, params DiagnosticResult[] expected)
	{
		...
		test.TestState.AdditionalReferences.Add(MetadataReference.CreateFromFile(typeof(BindableObject).Assembly.Location));
		test.TestState.AdditionalReferences.Add(MetadataReference.CreateFromFile(typeof(BindablePropertyAttribute).Assembly.Location));
